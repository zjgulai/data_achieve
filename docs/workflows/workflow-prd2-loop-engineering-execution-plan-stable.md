...
- Current source-control evidence: local branch `codex/release-3b-on-428` and `origin/codex/release-3b-on-428` include docs-only follow-up commits after deployed release commit `b81a4be2a47f387d381293db7c4b2932128f6708`; production remains on `b81a4be2a47f387d381293db7c4b2932128f6708`; `main` and `origin/main` remain at `42851929d59d82708c9380d36347ca721979297d`; draft PR #10 exists for `codex/release-3b-on-428 -> main` and has been observed as `OPEN`, `isDraft=true`, `mergeable=MERGEABLE`.
