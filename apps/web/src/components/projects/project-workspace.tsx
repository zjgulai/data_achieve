...
> = {
  ...
  agent: {
    ...
    icon: Bot,
    tone: "border-[#D7E3E6] bg-[#F3FAFB]",
    accent: "bg-[#4F8C99]",
    text: "text-[#3F6F79]",
    href: "/domain/agent" as Route,
  },
  platform: {
    label: "平台采集",
    shortLabel: "PLATFORM",
    description: "电商、社媒、视频和内容平台的采集方法",
    icon: Boxes,
    tone: "border-[#E4D8C8] bg-[#FFF9EF]",
    accent: "bg-[#B88A4B]",
    text: "text-[#7B5A31]",
    href: "/domain/platform" as Route,
  },
  governance: {
    label: "合规边界",
    shortLabel: "GOV",
    description: "授权、频控、禁止项和风险边界",
    icon: ShieldCheck,
    tone: "border-[#DDE1D2] bg-[#F8FBF4]",
    accent: "bg-[#718A57]",
    text: "text-[#52683D]",
    href: "/domain/governance" as Route,
  },
  mixed: {
    label: "混合项目",
    shortLabel: "MIXED",
