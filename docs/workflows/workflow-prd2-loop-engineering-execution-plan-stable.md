...
- Current source-control evidence: local branch `codex/release-3b-on-428` and `origin/codex/release-3b-on-428` now point to docs-only follow-up commit `d96c0b32193e4b4ff4302b7b3b11a770b0b8c6fd`; production remains on release commit `b81a4be2a47f387d381293db7c4b2932128f6708`; `main` and `origin/main` remain at `42851929d59d82708c9380d36347ca721979297d`; draft PR #10 exists for `codex/release-3b-on-428 -> main` and was observed as `OPEN`, `isDraft=true`, `mergeable=MERGEABLE`, with no checks reported on the final branch head.
